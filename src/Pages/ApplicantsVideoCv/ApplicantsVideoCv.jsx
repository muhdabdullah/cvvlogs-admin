...
function ApplicantsVideoCv(props) {
  ...
  useEffect(() => {
    jobData(localStorage.getItem("auth_id"), compIds);
    props.createprogress(localStorage.getItem("auth_id"), compIds, short);
  }, []);
  ...
  const statusSet = async () => {
    await props.createStatus(localStorage.getItem("auth_id"), compIds, short);
  };
  return (
    <>
      <Nav2 />
