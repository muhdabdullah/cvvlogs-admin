          ...
          props.pricingReducer.pricing.packages.length > 0
            ? props.pricingReducer.pricing.packages.map((pri) => (
                ...
                >
                  ...
                  <div className="col-md-12">
                    <strike>
                      <h1 className="text-primary text-center cash-stan-main">{!localStorage.getItem("userCurrentLocation") == "Pakistan"
                        ? "$ " + pri.price
                        : "Rs. " + "500"}
                  ...
                  <>
                    {
                      !localStorage.getItem("userCurrentLocation") == "Pakistan" ?
                        <MStripe2 id={pri.id} amount={!localStorage.getItem("userCurrentLocation") == "Pakistan"
                          ? pri.price
                          : pri.price_pkr} />
                        :
